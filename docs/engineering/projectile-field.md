...
- **Ruling 5 confirmed.** D-07 Part B kept the strict reading: contact while invulnerable spends the Projectile's one Graze (PLANEJAMENTO Section 4). The lenient alternative would have been a one-line change in `tick`.
